          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Unlock Seamless Efficiency with AutomationNation
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Streamline Your Marketing, Sales, and Admin Tasks with Our Monthly Subscription Service. Experience Professional Automation Solutions Tailored for Your Business Success.
              </p>
            </div>
